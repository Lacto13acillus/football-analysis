...
# Versi sederhana untuk skenario 1 pemain saja.
...
class PlayerBallAssigner:
    def __init__(self, max_possession_distance: float = 130.0):
        """
        Args:
            max_possession_distance: jarak maksimal (px) bola ke kaki pemain
                                     agar dianggap menguasai bola
        """
    ...
    def assign_ball_to_player(
        ...
        """
        Tentukan pemain terdekat ke bola pada satu frame.
        Karena hanya 1 pemain, cukup cek jarak pemain itu ke bola.

        Returns:
            track_id pemain, atau -1 jika tidak ada / terlalu jauh
        """
